...
const Features = () => {
  return (
<div className="px-8 py-20 bg-violet-100">
    <h1 className="font-bold text-center text-5xl text-violet-900 mb-12">
        Features & Benefits
    </h1>
    <div className="card-container flex justify-around space-x-4">
        <div className="card border border-gray-200 py-8 px-8 rounded-lg flex flex-col items-center shadow-lg hover:bg-yellow-300" >
            <div className="mb-4">
