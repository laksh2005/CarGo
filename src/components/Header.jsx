    ...
    <div className="bg-transparent hover:bg-black hover:bg-opacity-30 flex justify-between m-0 z-30 relative">
      ...
      <div className="flex items-center">
        <ul className="flex p-4 m-4">
          ...
          <li className="px-4 text-white font-bold hover:bg-yellow-300 hover:text-black rounded-lg"><Link to="/about">About Us</Link></li>
          <li className="px-4 text-white font-bold hover:bg-yellow-300 hover:text-black rounded-lg"><Link to="/contact">Contact Us</Link></li>
          <button 
